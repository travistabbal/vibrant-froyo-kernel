...
static int vbus_wake_lock_status;
// [[junghyunseok edit for fuel_int interrupt control of fuel_gauge 20100504
...
static DEVICE_ATTR(usbchargingcon, S_IRUGO | S_IWUGO, charging_status_show, charging_con_store);
//NAGSM_Android_SEL_Kernel_Aakash_20100503
...
//[HDLNC]uhm21c for 8922 start
		...
		{
		      //  pmic  charging  stop  
		      	maxim_charging_control(PM_CHARGER_TA, FALSE, batt_chg_full_1st);  // CHGENB, 0x1
...
//[HDLNC]uhm21c for 8922 start
#if defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
	else if((s3c_bat_info.device_state & OFFSET_CAMERA_ON) && (s3c_bat_info.bat_info.charging_enabled))
	{
...
#elif defined(CONFIG_T959_VER_B5) || defined(CONFIG_S5PC110_HAWK_BOARD)|| defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
...
#if defined (CONFIG_HAWK_VER_B0_HW_FIX) // NAGSM_Android_HQ_KERNEL_CLEE_20100831 : VF circuit was fixed in Dosirak Emul 0.1 board
...
{
	u32 con;
//[NAGSM_Android_HDLNC_SDcard_shinjonghyun_20101018 : do not close clock gate of MoviNAND
#if 0
	/*hsmmc clock disable*/
...
// [[junghyunseok edit for fuel_int interrupt control of fuel_gauge 20100504
#if defined(CONFIG_KEPLER_VER_B2) || defined(CONFIG_T959_VER_B5) || defined(CONFIG_S5PC110_HAWK_BOARD)|| defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
