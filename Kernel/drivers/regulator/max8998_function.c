...
EXPORT_SYMBOL(Set_MAX8998_PM_BUCK3_LDO4TO7_11_17_Voltage);
/*===========================================================================
...
#if defined(CONFIG_KEPLER_VER_B2) ||defined(CONFIG_T959_VER_B5) || defined(CONFIG_HAWK_VER_B0) || defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
