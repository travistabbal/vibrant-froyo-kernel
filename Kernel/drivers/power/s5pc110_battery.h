...
const int temper_table[][2] =  {
	...
	{ 1510,		-30	},
	{ 1500,		-20	},
	{ 1490,		-10	}, // [[junghyunseok edit temperature table 20100531
	{ 1480,		0	}, // 20  // 1480   // 1540
	{ 1470,		10	},
	{ 1460,		20	},
	{ 1450,		30	}, 	
	{ 1430,		40	}, // [[junghyunseok edit temperature table 20100531
	{ 1420,		50	}, 
	{ 1406,		60	},
	{ 1386,		70	},
	{ 1366,		80	},
...
#if defined(CONFIG_S5PC110_KEPLER_BOARD)|| defined(CONFIG_S5PC110_FLEMING_BOARD)
#define EVENT_TEMP_HIGH_BLOCK	temper_table[74][0]		// 64 °À¢ÁE
#define EVENT_TEMP_HIGH_RECOVER	temper_table[67][0]		// 57 °À¢ÁE
// [[ junghyunseok edit for charging block 20100503
#define TEMP_HIGH_BLOCK	temper_table[60][0]		// 50 °À¢ÁE
#define TEMP_HIGH_RECOVER	temper_table[53][0]		// 43 °À¢ÁE
#define TEMP_LOW_BLOCK		temper_table[11][0]		// 1  °À¢ÁE
#define TEMP_LOW_RECOVER	temper_table[16][0]		// 6 °À¢ÁE
// ]] junghyunseok edit for charging block 20100503
#elif (defined CONFIG_S5PC110_T959_BOARD)
// [[junghyunseok edit temperature table 20100531
#define EVENT_TEMP_HIGH_BLOCK	temper_table[88][0]		// 68 °À¢ÁE
#define EVENT_TEMP_HIGH_RECOVER	temper_table[84][0]		// 64 °À¢ÁE
#define TEMP_HIGH_BLOCK	temper_table[71][0]		// 51 °À¢ÁE
#define TEMP_HIGH_RECOVER	temper_table[63][0]		// 43 °À¢ÁE
#define TEMP_LOW_BLOCK		temper_table[19][0]		// -1 temp
#define TEMP_LOW_RECOVER	temper_table[24][0]		// 4 temp
// ]]junghyunseok edit temperature table 20100531
#elif defined(CONFIG_S5PC110_HAWK_BOARD)
#define EVENT_TEMP_HIGH_BLOCK	temper_table[85][0]		// 65 °À¢ÁE
#define EVENT_TEMP_HIGH_RECOVER	temper_table[75][0]		// 55 °À¢ÁE
#define TEMP_HIGH_BLOCK	temper_table[67][0]		// 47 °À¢ÁE
#define TEMP_HIGH_RECOVER	temper_table[60][0]		// 40 °À¢ÁE
#define TEMP_LOW_BLOCK		temper_table[19][0]		// -1 temp
#define TEMP_LOW_RECOVER	temper_table[24][0]		// 4 temp

#elif defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
// [[junghyunseok edit temperature table 20100531
//#define EVENT_TEMP_HIGH_BLOCK	temper_table[88][0]		// 68 °À¢ÁE  // 230 
#define EVENT_TEMP_HIGH_BLOCK	temper_table[85][0]		// 65 °À¢ÁE     // 65C    

//#define EVENT_TEMP_HIGH_RECOVER	temper_table[84][0]		// 64 °À¢ÁE  // 55C   // 290
#define EVENT_TEMP_HIGH_RECOVER	temper_table[75][0]		// 64 °À¢ÁE  // 55C

#define TEMP_HIGH_BLOCK	temper_table[71][0]		// 51 °À¢ÁE
#define TEMP_HIGH_RECOVER	temper_table[63][0]		// 43 °À¢ÁE
#define TEMP_LOW_BLOCK		temper_table[20][0]		// 0 temp
#define TEMP_LOW_RECOVER	temper_table[23][0]		// 3 temp
// ]]junghyunseok edit temperature table 20100531
#else
...
#if defined(CONFIG_S5PC110_KEPLER_BOARD) || (defined CONFIG_T959_VER_B0) || (defined CONFIG_T959_VER_B5) || (defined CONFIG_S5PC110_HAWK_BOARD) || defined(CONFIG_S5PC110_FLEMING_BOARD)|| defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)	
	S3C_ADC_EAR = 3,
	S3C_ADC_V_F = 4,
...
#if defined(CONFIG_KEPLER_VER_B2)||  defined(CONFIG_S5PC110_FLEMING_BOARD) || (defined CONFIG_T959_VER_B5) || (defined CONFIG_S5PC110_HAWK_BOARD)|| defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
...
#define CURRENT_OF_TOPOFF_CHG		200		//130mA
#elif defined(CONFIG_S5PC110_HAWK_BOARD)
...
#if defined(CONFIG_S5PC110_KEPLER_BOARD) || (defined CONFIG_S5PC110_T959_BOARD) || defined(CONFIG_S5PC110_HAWK_BOARD) || defined(CONFIG_S5PC110_FLEMING_BOARD)|| defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
