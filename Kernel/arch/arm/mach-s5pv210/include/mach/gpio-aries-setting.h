...
static unsigned int jupiter_gpio_table[][6] =
{
	...
	{S5PV210_MP04(6), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST}, 
#else
...
#if defined(CONFIG_S5PC110_KEPLER_BOARD) || defined(CONFIG_S5PC110_FLEMING_BOARD) || defined (CONFIG_S5PC110_HAWK_BOARD)
