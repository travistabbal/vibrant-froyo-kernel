...
#define V4L2_CID_CAMERA_SET_FLASH							(V4L2_CID_PRIVATE_BASE+117)
#elif defined (CONFIG_S5PC110_KEPLER_BOARD) || defined (CONFIG_S5PC110_T959_BOARD) || defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
